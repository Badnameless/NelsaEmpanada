...
<body class="h-full">
    ...
    <div class="hidden xl:fixed xl:inset-y-0 xl:z-50 xl:flex xl:w-72 xl:flex-col">
        ...
        <nav class="flex flex-1 flex-col">
            ...
            <li>
                <ul role="list" class="-mx-2 space-y-1">
                <li>
                    <a href="/" class="@yield('selectedSales') flex gap-x-3 rounded-md p-2 text-sm leading-6 font-semibold">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" class="h-6 w-6">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 3h2l3.28 12.43a2 2 0 0 0 1.92 1.57h8.8a2 2 0 0 0 1.92-1.57L19 5H6">
                            </path>
            ...
            <li>
                <div class="text-sm font-semibold leading-6 text-gray-400">Administrativo</div>
                <ul role="list" class="-mx-2 mt-2 space-y-1">
                <li>
                    <!-- Current: "bg-gray-800 text-white", Default: "text-gray-400 hover:text-white hover:bg-gray-800" -->
                    <a href="/productos" class="@yield('selectedProduct') group flex gap-x-3 rounded-md p-2 text-sm leading-6 font-semibold">
                        <svg class="h-6 w-6 shrink-0" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true">
                ...
                <li>
                    <a href="/consultar-ventas" class="@yield('selectedConsult') group flex gap-x-3 rounded-md p-2 text-sm leading-6 font-semibold">
                        <svg class="h-6 w-6 shrink-0" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true">
                    ...
                    <span class="truncate">Consultar ventas</span>
                    </a>
                </li>
                </ul>
            </li>
    ...
    <div class="xl:pl-72">
        <div class="sticky top-0 z-40 flex h-16 shrink-0 items-center gap-x-6 border-b border-white/5 bg-gray-900 px-4 shadow-sm sm:px-6 lg:px-8">
            <h1 class="text-2xl font-semibold leading-7 text-white">@yield('SiteName')</h1>
            @auth
                <form method="POST" action="{{ route('logout') }}">
                    ...
                    onclick="event.preventDefault();
                        ...
                        <div class="text-white font-bold absolute top-0 right-0 m-5 mr-8 hover:underline">
                            Cerrar Sesión
                        </div>
                    </a>
                </form>
